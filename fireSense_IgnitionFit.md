...
<tbody>
  <tr>
   ...
   <td style="text-align:left;"> The column name(s) in the `fireSense_ignitionCovariates` that is climate, in a named list, .e.g. `climateVariablesForFire = list('ignition' = 'MDC')` </td>
...
<tbody>
  <tr>
   <td style="text-align:left;"> covMinMax_ignition </td>
   <td style="text-align:left;"> data.table </td>
   <td style="text-align:left;"> Table of the original ranges (min and max) of covariates </td>
  </tr>
  <tr>
  ...
  <tr>
   <td style="text-align:left;"> ignitionRescalers </td>
   <td style="text-align:left;"> integer </td>
   <td style="text-align:left;"> scaling vector if rescaling variables to 0-10 range </td>
  </tr>
</tbody>
</table>
